...
<body>
    <form action="{{route('user.update',$data->id)}}" method="POST">@csrf
  ...
  <div class="col-md-6 mb-3">
    ...
    <input type="text" class="form-control" id="address" name="address" value="{{ $data->address}}" placeholder="Enter your address">
  </div>

  <!-- Message -->
  <div class="col-12 mb-3">
    <label for="message" class="form-label">Message</label>
    <textarea class="form-control" id="message" name="message"   rows="4" placeholder="Enter your message">{{ $data->message}}</textarea>
  </div>
